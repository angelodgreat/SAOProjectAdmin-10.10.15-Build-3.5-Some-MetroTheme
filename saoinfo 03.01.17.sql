...
INSERT INTO `saoevent2015-2016` VALUES (2,'2017-03-01','Student Activity Center (Second flr)','te','18:00:00','19:30:00','Philippine Nursing Research Society (PNRS)','CSA','Academic Related',''),(3,'2017-03-01','TechCenter Lanai with Lights','test','18:00:00','20:00:00','Photographers Club (Photo Club)','CSA','Academic Related','');
...
CREATE TABLE `saoreminder` (
  `saonotenumber` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `saoreminder` VALUES (2,'test','2017-03-01'),(3,'ts','2017-03-01'),(4,'ts','2017-03-01');
...
-- Dump completed on 2017-03-01  8:06:28
