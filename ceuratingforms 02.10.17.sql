...
CREATE TABLE `allrf` (
  ...
  PRIMARY KEY (`idallrf`)
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
...
INSERT INTO `allrf` VALUES (98,'kjbhfhgfjh',5,8,NULL,40);
...
CREATE TABLE `pointsinfo` (
  ...
  `Remarks` varchar(50) COLLATE latin1_general_cs DEFAULT NULL,
  PRIMARY KEY (`StudNo`)
...
INSERT INTO `pointsinfo` VALUES ('1',40,''),('13-01913',125,''),('14-00978',51294,'Gold'),('14-01122',105,''),('14-02316',48,''),('15-01827',0,' ');
...
INSERT INTO `ratingform2` VALUES (1,'14-01122','plpl','Very High','Supervised','Off-Campus','Working Committee Co-Chairman',5,6,30,1),(2,'14-02316','3425','High','Supervised','In-Campus','Over-all Co-Chairman',4,12,48,1),(3,'14-00978','df,ljdlksajdlaj','Very High','Supervised','Off-Campus','Coordinator',5,10,50,0);
...
CREATE TABLE `ratingform3` (
  ...
  `ActStat` varchar(20) COLLATE latin1_general_cs NOT NULL,
...
INSERT INTO `ratingform7` VALUES (1,'15-01827','rf7rbRO4','rf7rbSR3','rf7rbR3','rf7rbI3','rf7rbC3','rf7rbA3','rf7rbP4','Secretary',23,17,123,3220,0);
...
-- Dump completed on 2017-02-10 18:01:27
