...
CREATE TABLE `points_ranges` (
  ...
  `awards` varchar(10) COLLATE latin1_general_cs NOT NULL,
...
INSERT INTO `points_ranges` VALUES (1,'Gold',7000),(2,'Silver',3000),(3,'Bronze',1000);
...
-- Dump completed on 2017-02-26 15:18:01
